...
public final class SlaughterhouseServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<slaughterhouse.ProductRequest,
      slaughterhouse.AnimalResponse> getGetAnimalsForProductMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAnimalsForProduct",
      requestType = slaughterhouse.ProductRequest.class,
      responseType = slaughterhouse.AnimalResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<slaughterhouse.ProductRequest,
      slaughterhouse.AnimalResponse> getGetAnimalsForProductMethod() {
    io.grpc.MethodDescriptor<slaughterhouse.ProductRequest, slaughterhouse.AnimalResponse> getGetAnimalsForProductMethod;
      ...
      synchronized (SlaughterhouseServiceGrpc.class) {
        if ((getGetAnimalsForProductMethod = SlaughterhouseServiceGrpc.getGetAnimalsForProductMethod) == null) {
          SlaughterhouseServiceGrpc.getGetAnimalsForProductMethod = getGetAnimalsForProductMethod = 
              io.grpc.MethodDescriptor.<slaughterhouse.ProductRequest, slaughterhouse.AnimalResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "SlaughterhouseService", "GetAnimalsForProduct"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  slaughterhouse.ProductRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  slaughterhouse.AnimalResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<slaughterhouse.AnimalRequest,
      slaughterhouse.ProductResponse> getGetProductsForAnimalMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetProductsForAnimal",
      requestType = slaughterhouse.AnimalRequest.class,
      responseType = slaughterhouse.ProductResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<slaughterhouse.AnimalRequest,
      slaughterhouse.ProductResponse> getGetProductsForAnimalMethod() {
    io.grpc.MethodDescriptor<slaughterhouse.AnimalRequest, slaughterhouse.ProductResponse> getGetProductsForAnimalMethod;
      ...
      synchronized (SlaughterhouseServiceGrpc.class) {
        if ((getGetProductsForAnimalMethod = SlaughterhouseServiceGrpc.getGetProductsForAnimalMethod) == null) {
          SlaughterhouseServiceGrpc.getGetProductsForAnimalMethod = getGetProductsForAnimalMethod = 
              io.grpc.MethodDescriptor.<slaughterhouse.AnimalRequest, slaughterhouse.ProductResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "SlaughterhouseService", "GetProductsForAnimal"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  slaughterhouse.AnimalRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  slaughterhouse.ProductResponse.getDefaultInstance()))
  ...
  public static abstract class SlaughterhouseServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAnimalsForProduct(slaughterhouse.ProductRequest request,
        io.grpc.stub.StreamObserver<slaughterhouse.AnimalResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getGetAnimalsForProductMethod(), responseObserver);
    }

    /**
     */
    public void getProductsForAnimal(slaughterhouse.AnimalRequest request,
        io.grpc.stub.StreamObserver<slaughterhouse.ProductResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                slaughterhouse.ProductRequest,
                slaughterhouse.AnimalResponse>(
                  this, METHODID_GET_ANIMALS_FOR_PRODUCT)))
          .addMethod(
            getGetProductsForAnimalMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                slaughterhouse.AnimalRequest,
                slaughterhouse.ProductResponse>(
  ...
  public static final class SlaughterhouseServiceBlockingStub extends io.grpc.stub.AbstractStub<SlaughterhouseServiceBlockingStub> {
    ...
    /**
     */
    public slaughterhouse.AnimalResponse getAnimalsForProduct(slaughterhouse.ProductRequest request) {
    ...
    /**
     */
    public slaughterhouse.ProductResponse getProductsForAnimal(slaughterhouse.AnimalRequest request) {
      return blockingUnaryCall(
  ...
  public static final class SlaughterhouseServiceFutureStub extends io.grpc.stub.AbstractStub<SlaughterhouseServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<slaughterhouse.AnimalResponse> getAnimalsForProduct(
        slaughterhouse.ProductRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<slaughterhouse.ProductResponse> getProductsForAnimal(
        slaughterhouse.AnimalRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ANIMALS_FOR_PRODUCT:
          serviceImpl.getAnimalsForProduct((slaughterhouse.ProductRequest) request,
              (io.grpc.stub.StreamObserver<slaughterhouse.AnimalResponse>) responseObserver);
          break;
        case METHODID_GET_PRODUCTS_FOR_ANIMAL:
          serviceImpl.getProductsForAnimal((slaughterhouse.AnimalRequest) request,
              (io.grpc.stub.StreamObserver<slaughterhouse.ProductResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SlaughterhouseServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return slaughterhouse.SlaughterhouseProto.getDescriptor();
    }
